...
public class LoginPrimeiroAcesso extends AppCompatActivity {
    ...
    private ImageView login_cad_Id_img_usuario;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login_cad_Id_img_usuario = (ImageView) findViewById(R.id.login_cad_Id_img_usuario);
...
//      Mostra a matrícula do Aluno
    ...
    private void salvar(){
        ...
        if(NetworkUtil.virificaConexao(LoginPrimeiroAcesso.this) == false){
            Toast.makeText(this, "Sem conexão", Toast.LENGTH_SHORT).show();
        }else if(validarSalvar() == true){
            dadosUsuario();
    ...
    class ClasseAtualizar extends AsyncTask<Usuario,Void, String>{
        ...
        protected String doInBackground(Usuario... params) {
            ...
            try {
                ...
                conexao = NetworkUtil.conectar("atualizarUsuario="+objJson);
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("1")){
                Toast.makeText(LoginPrimeiroAcesso.this, "Perfil atualizado com sucesso", Toast.LENGTH_SHORT).show();
                chamaTelaMainActivity();
            }else{
                Toast.makeText(LoginPrimeiroAcesso.this, "Ocorreu um erro com a conexão", Toast.LENGTH_SHORT).show();
            }
        }
        ...
        if (requestCode == TIRAR_FOTO) {
            if (resultCode == RESULT_OK) {
                if(data != null) {
                    ...
                    login_cad_Id_img_usuario.setImageBitmap(bitmap);
