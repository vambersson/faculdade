...
public class DiaFragmentDomingo extends Fragment {

    private static final int REQUEST_DISCIPLINA = 101;
    private final int NUMERO_DIA = 1;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dia_domingo_fragment,container,false);
...
//        só notifica com o app aberto
        ...
        PendingIntent resultPendingIntent = stackBuilder.getPendingIntent(301, PendingIntent.FLAG_UPDATE_CURRENT);
