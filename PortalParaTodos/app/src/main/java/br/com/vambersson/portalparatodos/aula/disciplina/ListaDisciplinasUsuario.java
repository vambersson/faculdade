...
//      Verifica total de seleção das disciplinas
        ...
        if(totaldisciplinaMarcada > 1){
            ...
            Snackbar.make(getListView(),getResources().getString(R.string.message_alerta_disciplina_seleciona_uma) , Snackbar.LENGTH_LONG).setAction("Action", null).show();
            ...
            for(int i=0;i < listView.getCount();i++){
                ...
                if(codigoDisciplinaTroca != null){
                    ...
                    Snackbar.make(getListView(), getResources().getString(R.string.message_alerta_disciplina_remover), Snackbar.LENGTH_LONG).setAction("Action", null).show();

                }else if(codigoDisciplinaTroca == null){
                    it.putExtra("tipo","update0");
                    Snackbar.make(getListView(), getResources().getString(R.string.message_alerta_disciplina_nao_auteracao), Snackbar.LENGTH_LONG).setAction("Action", null).show();
            ...
            for(int i=0;i < listView.getCount();i++){
                ...
                if(listView.isItemChecked(i) == true && codigoDisciplinaTroca == null){
                    ...
                    totaldisciplinaMarcada = 0;
                    Snackbar.make(getListView(), getResources().getString(R.string.message_alerta_disciplina_inserir), Snackbar.LENGTH_LONG).setAction("Action", null).show();
                    ...
                    totaldisciplinaMarcada = 0;
                    Snackbar.make(getListView(), getResources().getString(R.string.message_alerta_disciplina_atualizar), Snackbar.LENGTH_LONG).setAction("Action", null).show();
                }else  if(listView.isItemChecked(i) == true && codigoDisciplinaTroca != null && listaDisciplinas.get(i).getCodigo().toString().equals(codigoDisciplinaTroca) ){
