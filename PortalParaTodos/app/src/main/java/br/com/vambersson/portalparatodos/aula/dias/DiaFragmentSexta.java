...
public class DiaFragmentSexta extends Fragment {
    ...
    private static final int REQUEST_DISCIPLINA = 106;
    private final int NUMERO_DIA = 6;
...
//        só notifica com o app aberto
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(getActivity())
                ...
                .setContentText("Teve auteração na sua agenda de aula de " + getResources().getString(R.string.dia_tv_sexta));
        ...
        PendingIntent resultPendingIntent = stackBuilder.getPendingIntent(306, PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        mNotificationManager.notify(306, notification);
